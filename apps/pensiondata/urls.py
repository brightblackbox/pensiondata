...
urlpatterns = [
    ...
    url(r'^api/charts/$', api_chart_list, name = 'api_chart_list'),
    url(r'^api/chart/contribs/(?P<government_id>\d+)/$', api_chart_contribs, name = 'api_chart_contribs'),
    url(r'^api/chart/(?P<query>\w+)/(?P<government_id>\d+)/$', api_chart_data, name = 'api_chart_data'),
