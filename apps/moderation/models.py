...
from .constants import (MODERATION_READY_STATE,
                        ...
                        MODERATION_ADD_STATE,
                        MODERATION_DELETE_STATE,
...
MODERATION_STATES = Choices(
    ...
    (MODERATION_ADD_STATE, 'add', _('Add')),
    (MODERATION_DELETE_STATE, 'delete', _('Delete')),
)
...
class ModeratedObject(models.Model):
    ...
    def _moderate(self, new_status, by, reason):
        # customize when approving delete.
        if (self.state == MODERATION_DELETE_STATE and
                self.status == MODERATION_STATUS_PENDING and
            ...
            # This will delete moderated_objects as well as base_object.
            # Cannot avoid cascade-deleting because of GenericRelation in register.py 84
            if self.changed_by:
